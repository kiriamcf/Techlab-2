...
Route::name('api.')->group(function () {
    ...
    Route::match(['put', 'patch'], '/rfid_petitions/{rfid_petition}/solve', [RFIDPetitionController::class, 'destroy']);
    ...
    Route::put('/user/{user}', [AuthenticationController::class, 'updateUser']);
